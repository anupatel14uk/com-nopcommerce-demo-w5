...
public class TestSuite extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        checkOutPage.enterFirstname("anu");
        checkOutPage.enterLastname("patel");
        checkOutPage.enterEmail("anu@gmail.com");
        checkOutPage.selectCountry("India");
        checkOutPage.enterCity("Dhra");
        checkOutPage.enterAddress1("Homefiled");
        checkOutPage.enterZipCode("363310");
        checkOutPage.enterPhoneNumber("01234567891");
        ...
        checkOutPage.enterCardHolderName("anu patel");
